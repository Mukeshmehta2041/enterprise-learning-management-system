# Mobile Day 1 – Project setup and tooling

**Focus:** Initialize the LMS mobile app with React Native + TypeScript and baseline tooling so you can iterate quickly.

**References:** [docs/mobile/01-architecture-mobile.md](../docs/mobile/01-architecture-mobile.md), [docs/mobile/06-testing-and-release.md](../docs/mobile/06-testing-and-release.md).
...
When all checkboxes above are done, Mobile Day 1 is complete. Next: [Mobile Day 2](mobile-day-2.md) (Navigation shell and core screens).
