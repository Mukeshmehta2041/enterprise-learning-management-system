# Frontend Day 19 – Instructor authoring tools and content workflows

**Focus:** Improve instructor tooling for creating and managing courses, modules, lessons, and assignments with clear workflows.

**References:** [docs/frontend/02-design-system.md](../docs/frontend/02-design-system.md), [docs/frontend/03-routing-and-layout.md](../docs/frontend/03-routing-and-layout.md), [docs/02-microservices.md](../docs/02-microservices.md).
...
- [ ] Provide forms for creating and editing assignments (title, description, due date, grading scheme, attachments).
- [ ] Show how assignments map to modules/courses and let instructors easily navigate between them.
...
When all checkboxes above are done, Frontend Day 19 is complete. Next: [Frontend Day 20](frontend-day-20.md) (Frontend production readiness and rollout checklist).
