# Mobile Day 2 – Navigation shell and core screens

**Focus:** Set up React Navigation with an auth stack and main tab navigator, and create placeholder screens for key areas.

**References:** [docs/mobile/02-navigation-and-ux-flows.md](../docs/mobile/02-navigation-and-ux-flows.md), [docs/mobile/01-architecture-mobile.md](../docs/mobile/01-architecture-mobile.md).
...
- [ ] Update the **Progress** table at the top of this file when Day 2 is complete.

---

## Done?

When all checkboxes above are done, Mobile Day 2 is complete. Next: [Mobile Day 3](mobile-day-3.md) (Mobile design system primitives).
