...
export default function CoursesScreen() {
  ...
  const activeFiltersCount = Object.values(filters).filter(v => v !== '' && v !== 'createdAt,desc').length;
  ...
  const renderEmpty = () => (
    <EmptyState
      ...
      description={search ? `We couldn't find any courses matching "${search}"` : "Our course catalog is currently empty."}
      icon="search-outline"
  ...
  return (
    <View className="flex-1 bg-background">
      <View className="p-6 pb-2 bg-white border-b border-slate-100">
        <AppText variant="h1" className="mb-4">Explore Courses</AppText>
